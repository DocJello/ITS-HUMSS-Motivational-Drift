...
import { AssessmentAttempt, AssessmentType, Assessment, Topic } from '../../types';
...
const ResultsDashboard: React.FC<ResultsDashboardProps> = ({ studentAttempts, assessments, topics }) => {
    ...
    const selectedAttemptDetails = useMemo(() => {
        ...
        const questions = assessment.questionIds.map(qid => {
