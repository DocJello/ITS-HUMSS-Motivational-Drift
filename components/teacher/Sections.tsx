...
import { AssessmentAttempt, AssessmentType, Section, Assessment, Topic } from '../../types';
...
const Sections: React.FC<SectionsProps> = ({ allAttempts, teacherSections, assessments, topics }) => {
